...
const services: ServiceGroup[] = [
  {
    ...
    items: [
      { name: { ar: "حلاقة شعر", en: "Haircut" }, duration: { ar: "30 دقيقة", en: "30 min" }, price: { ar: "10 د.أ", en: "10 JOD" } },
      ...
      { name: { ar: "سشوار", en: "Blow dry" }, duration: { ar: "15 دقيقة", en: "15 min" }, price: { ar: "5 د.أ", en: "5 JOD" } },
      { name: { ar: "ترتمنت للشعر", en: "Hair treatment" }, duration: { ar: "15 دقيقة", en: "15 min" }, price: { ar: "15 د.أ", en: "15 JOD" } },
      { name: { ar: "بروتين للشعر", en: "Hair protein" }, duration: { ar: "60 دقيقة", en: "60 min" }, price: { ar: "يبدأ من 35 د.أ", en: "From 35 JOD" } },
      { name: { ar: "صبغة للشعر (الغامق)", en: "Dark hair colour" }, duration: { ar: "20 دقيقة", en: "20 min" }, price: { ar: "10 د.أ", en: "10 JOD" } },
      { name: { ar: "صبغة فاتحة / سحب لون", en: "Light colour / bleach" }, duration: { ar: "120 دقيقة", en: "120 min" }, price: { ar: "50 د.أ", en: "50 JOD" } },
      { name: { ar: "حنة للشعر أو اللحية", en: "Hair or beard henna" }, duration: { ar: "15 دقيقة", en: "15 min" }, price: { ar: "8 د.أ", en: "8 JOD" } },
    ],
  },
  {
    id: "nails",
  ...
  },
  {
    ...
    items: [
      {
        name: { ar: "ادفانس", en: "Advance" },
        duration: { ar: "45 دقيقة", en: "45 min" },
        price: { ar: "50 د.أ", en: "50 JOD" },
        note: { ar: "هيدرافيشل، قناع، سنفرة، مقشرات، مرطبات وبخار", en: "Hydrafacial, mask, scrub, exfoliation, moisturisers and steam" },
      },
      {
        name: { ar: "اكسبريس", en: "Express" },
        duration: { ar: "25 دقيقة", en: "25 min" },
        price: { ar: "20 د.أ", en: "20 JOD" },
        note: { ar: "قناع وبخار", en: "Mask and steam" },
      },
      {
        name: { ar: "ادفانس 2", en: "Advance 2" },
        duration: { ar: "35 دقيقة", en: "35 min" },
        price: { ar: "35 د.أ", en: "35 JOD" },
        note: { ar: "قناع، سنفرة، مقشرات، مرطبات، كريمات وبخار", en: "Mask, scrub, exfoliation, moisturisers, creams and steam" },
      },
    ],
  },
];
