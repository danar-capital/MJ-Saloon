...
export const bookingServices: BookingService[] = [
  { id: "haircut", categoryId: "hair", name: { ar: "حلاقة شعر", en: "Haircut" }, durationMinutes: 30, price: { ar: "10 د.أ", en: "10 JOD" }, specialty: "hair" },
  ...
  { id: "blow-dry", categoryId: "hair", name: { ar: "سشوار", en: "Blow dry" }, durationMinutes: 15, price: { ar: "5 د.أ", en: "5 JOD" }, specialty: "hair" },
  ...
  { id: "hair-protein", categoryId: "hair", name: { ar: "بروتين للشعر", en: "Hair protein" }, durationMinutes: 60, price: { ar: "يبدأ من 35 د.أ", en: "From 35 JOD" }, specialty: "hair" },
  { id: "dark-colour", categoryId: "hair", name: { ar: "صبغة للشعر (الغامق)", en: "Dark hair colour" }, durationMinutes: 20, price: { ar: "10 د.أ", en: "10 JOD" }, specialty: "hair" },
  { id: "light-colour", categoryId: "hair", name: { ar: "صبغة فاتحة / سحب لون", en: "Light colour / bleach" }, durationMinutes: 120, price: { ar: "50 د.أ", en: "50 JOD" }, specialty: "hair" },
  { id: "henna", categoryId: "hair", name: { ar: "حنة للشعر أو اللحية", en: "Hair or beard henna" }, durationMinutes: 15, price: { ar: "8 د.أ", en: "8 JOD" }, specialty: "hair" },
  ...
  { id: "package-advance", categoryId: "packages", name: { ar: "ادفانس", en: "Advance" }, durationMinutes: 45, price: { ar: "50 د.أ", en: "50 JOD" }, specialty: "hair" },
  { id: "package-express", categoryId: "packages", name: { ar: "اكسبريس", en: "Express" }, durationMinutes: 25, price: { ar: "20 د.أ", en: "20 JOD" }, specialty: "hair" },
  { id: "package-advance-2", categoryId: "packages", name: { ar: "ادفانس 2", en: "Advance 2" }, durationMinutes: 35, price: { ar: "35 د.أ", en: "35 JOD" }, specialty: "hair" },
];
